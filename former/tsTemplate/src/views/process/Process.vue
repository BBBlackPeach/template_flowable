    ...
    <div class="layout">
        <div class="process">
            ...
            <div class="demo-control-bar">
                <div class="open-model-button" @click="controlDrawerVisible = true"><el-icon>
                        <setting />
                    </el-icon></div>
            </div>
            <el-drawer v-model="controlDrawerVisible" size="400px" title="偏好设置" append-to-body destroy-on-close>
                <el-form :model="controlForm" size="small" label-width="100px" class="control-form" @submit.prevent>
                    ...
                    <el-switch v-model="pageMode" active-text="dark" inactive-text="light"
                        @change="changePageMode"></el-switch>
                </el-form>
            </el-drawer>
...
import CustomContentPadProvider from '@/views/process/Process/designer/plugins/content-pad';
// 自定义左侧菜单（修改 默认任务 为 用户任务）
import CustomPaletteProvider from '@/views/process/Process/designer/plugins/palette';
import Log from '@/views/process/Process/Log';
// 任务resize
...
import '@/views/process/Process/theme/index.scss';
