        ...
        <el-table key="enum-table" :data="fieldEnumList" size="small" max-height="240" border fit>
          ...
          <el-table-column label="操作" width="90px">
            <template v-slot="{ row, $index }">
              ...
              <el-divider direction="vertical" />
              <el-button link type="" style="color: #ff4d4f"
                @click="removeFieldOptionItem(row, $index, 'enum')">移除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </template>
      ...
      <el-table key="validation-table" :data="fieldConstraintsList" size="small" max-height="240" border fit>
        ...
        <el-table-column label="操作" width="90px">
          <template v-slot="{ row, $index }">
            ...
            <el-divider direction="vertical" />
            <el-button link type="" style="color: #ff4d4f"
              @click="removeFieldOptionItem(row, $index, 'constraint')">移除</el-button>
          </template>
        </el-table-column>
      </el-table>
      ...
      <el-table key="property-table" :data="fieldPropertiesList" size="small" max-height="240" border fit>
        ...
        <el-table-column label="操作" width="90px">
          <template v-slot="{ row, $index }">
            ...
            <el-divider direction="vertical" />
            <el-button link type="" style="color: #ff4d4f"
              @click="removeFieldOptionItem(row, $index, 'property')">移除</el-button>
          </template>
        </el-table-column>
      </el-table>
